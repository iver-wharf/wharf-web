...
export class ProviderService {
     ...
     * Add provider to database. Token in post object has to exists or should be empty. Token will has to be updated Provider ID during this operation. Added in v0.3.9.
     * @param provider Provider to create
     * @param pretty Pretty indented JSON output
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createProvider(provider?: RequestProvider, pretty?: boolean, observe?: 'body', reportProgress?: boolean): Observable<ResponseProvider>;
    public createProvider(provider?: RequestProvider, pretty?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseProvider>>;
    public createProvider(provider?: RequestProvider, pretty?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseProvider>>;
    public createProvider(provider?: RequestProvider, pretty?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getProvider(providerId: number, pretty?: boolean, observe?: 'body', reportProgress?: boolean): Observable<ResponseProvider>;
    public getProvider(providerId: number, pretty?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseProvider>>;
    public getProvider(providerId: number, pretty?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseProvider>>;
    public getProvider(providerId: number, pretty?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getProviderList(limit?: number, offset?: number, orderby?: Array<string>, name?: string, url?: string, nameMatch?: string, urlMatch?: string, match?: string, pretty?: boolean, observe?: 'body', reportProgress?: boolean): Observable<ResponsePaginatedProviders>;
    public getProviderList(limit?: number, offset?: number, orderby?: Array<string>, name?: string, url?: string, nameMatch?: string, urlMatch?: string, match?: string, pretty?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponsePaginatedProviders>>;
    public getProviderList(limit?: number, offset?: number, orderby?: Array<string>, name?: string, url?: string, nameMatch?: string, urlMatch?: string, match?: string, pretty?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponsePaginatedProviders>>;
    public getProviderList(limit?: number, offset?: number, orderby?: Array<string>, name?: string, url?: string, nameMatch?: string, urlMatch?: string, match?: string, pretty?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * Deprecated since v5.0.0. Planned for removal in v6.0.0. Use &#x60;GET /provider&#x60; instead. Added in v0.3.9.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * Returns arrays of providers that match to search criteria. It takes into consideration name, URL and token ID. Deprecated since v5.0.0. Planned for removal in v6.0.0. Use &#x60;GET /provider&#x60; instead. Added in v0.3.9.
     ...
     * Creates a new provider if a match is not found. Deprecated since v5.0.0. Planned for removal in v6.0.0. Use POST /provider to create, or PUT /provider/{providerId} to update instead. Added in v4.1.0.
     * @param provider provider object
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * Updates a provider by replacing all of its fields. Added in v5.0.0.
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateProvider(providerId: number, provider?: RequestProviderUpdate, pretty?: boolean, observe?: 'body', reportProgress?: boolean): Observable<ResponseProvider>;
    public updateProvider(providerId: number, provider?: RequestProviderUpdate, pretty?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseProvider>>;
    public updateProvider(providerId: number, provider?: RequestProviderUpdate, pretty?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseProvider>>;
    public updateProvider(providerId: number, provider?: RequestProviderUpdate, pretty?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
