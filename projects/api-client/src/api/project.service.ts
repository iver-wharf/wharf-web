...
export class ProjectService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getProjectOverrides(projectId: number, observe?: 'body', reportProgress?: boolean): Observable<ResponseProjectOverrides>;
    public getProjectOverrides(projectId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseProjectOverrides>>;
    public getProjectOverrides(projectId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseProjectOverrides>>;
    public getProjectOverrides(projectId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public oldStartProjectBuild(projectId: number, stage: string, branch?: string, environment?: string, inputs?: string, observe?: 'body', reportProgress?: boolean): Observable<ResponseBuildReferenceWrapper>;
    public oldStartProjectBuild(projectId: number, stage: string, branch?: string, environment?: string, inputs?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseBuildReferenceWrapper>>;
    public oldStartProjectBuild(projectId: number, stage: string, branch?: string, environment?: string, inputs?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseBuildReferenceWrapper>>;
    public oldStartProjectBuild(projectId: number, stage: string, branch?: string, environment?: string, inputs?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateProjectOverrides(projectId: number, overrides?: RequestProjectOverridesUpdate, observe?: 'body', reportProgress?: boolean): Observable<ResponseProjectOverrides>;
    public updateProjectOverrides(projectId: number, overrides?: RequestProjectOverridesUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseProjectOverrides>>;
    public updateProjectOverrides(projectId: number, overrides?: RequestProjectOverridesUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseProjectOverrides>>;
    public updateProjectOverrides(projectId: number, overrides?: RequestProjectOverridesUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
