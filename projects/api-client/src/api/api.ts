...
export const APIS = [ArtifactService, BranchService, BranchesService, BuildService, EngineService, HealthService, MetaService, ProjectService, ProviderService, TestResultService, TokenService];
