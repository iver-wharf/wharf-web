...
export class BuildService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getBuild(buildId: number, observe?: 'body', reportProgress?: boolean): Observable<ResponseBuild>;
    public getBuild(buildId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseBuild>>;
    public getBuild(buildId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseBuild>>;
    public getBuild(buildId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getBuildList(limit?: number, offset?: number, orderby?: Array<string>, projectId?: number, scheduledAfter?: Date, scheduledBefore?: Date, finishedAfter?: Date, finishedBefore?: Date, environment?: string, gitBranch?: string, stage?: string, isInvalid?: boolean, status?: 'Scheduling' | 'Running' | 'Completed' | 'Failed', statusId?: number, environmentMatch?: string, gitBranchMatch?: string, stageMatch?: string, match?: string, observe?: 'body', reportProgress?: boolean): Observable<ResponsePaginatedBuilds>;
    public getBuildList(limit?: number, offset?: number, orderby?: Array<string>, projectId?: number, scheduledAfter?: Date, scheduledBefore?: Date, finishedAfter?: Date, finishedBefore?: Date, environment?: string, gitBranch?: string, stage?: string, isInvalid?: boolean, status?: 'Scheduling' | 'Running' | 'Completed' | 'Failed', statusId?: number, environmentMatch?: string, gitBranchMatch?: string, stageMatch?: string, match?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponsePaginatedBuilds>>;
    public getBuildList(limit?: number, offset?: number, orderby?: Array<string>, projectId?: number, scheduledAfter?: Date, scheduledBefore?: Date, finishedAfter?: Date, finishedBefore?: Date, environment?: string, gitBranch?: string, stage?: string, isInvalid?: boolean, status?: 'Scheduling' | 'Running' | 'Completed' | 'Failed', statusId?: number, environmentMatch?: string, gitBranchMatch?: string, stageMatch?: string, match?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponsePaginatedBuilds>>;
    public getBuildList(limit?: number, offset?: number, orderby?: Array<string>, projectId?: number, scheduledAfter?: Date, scheduledBefore?: Date, finishedAfter?: Date, finishedBefore?: Date, environment?: string, gitBranch?: string, stage?: string, isInvalid?: boolean, status?: 'Scheduling' | 'Running' | 'Completed' | 'Failed', statusId?: number, environmentMatch?: string, gitBranchMatch?: string, stageMatch?: string, match?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getBuildLogList(buildId: number, observe?: 'body', reportProgress?: boolean): Observable<Array<ResponseLog>>;
    public getBuildLogList(buildId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ResponseLog>>>;
    public getBuildLogList(buildId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ResponseLog>>>;
    public getBuildLogList(buildId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    /**
     * NOT IMPLEMENTED YET
     * This endpoint was never implemented! Deprecated since v5.0.0. Planned for removal in v6.0.0. Use &#x60;GET /build&#x60; instead.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateBuild(buildId: number, status: 'Scheduling' | 'Running' | 'Completed' | 'Failed', observe?: 'body', reportProgress?: boolean): Observable<ResponseBuild>;
    public updateBuild(buildId: number, status: 'Scheduling' | 'Running' | 'Completed' | 'Failed', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseBuild>>;
    public updateBuild(buildId: number, status: 'Scheduling' | 'Running' | 'Completed' | 'Failed', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseBuild>>;
    public updateBuild(buildId: number, status: 'Scheduling' | 'Running' | 'Completed' | 'Failed', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (status === null || status === undefined) {
            throw new Error('Required parameter status was null or undefined when calling updateBuild.');
        }
