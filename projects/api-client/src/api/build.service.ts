...
export class BuildService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startProjectBuild(projectId: number, stage?: string, branch?: string, environment?: string, inputs?: RequestBuildInputs, observe?: 'body', reportProgress?: boolean): Observable<ResponseBuildReferenceWrapper>;
    public startProjectBuild(projectId: number, stage?: string, branch?: string, environment?: string, inputs?: RequestBuildInputs, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseBuildReferenceWrapper>>;
    public startProjectBuild(projectId: number, stage?: string, branch?: string, environment?: string, inputs?: RequestBuildInputs, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseBuildReferenceWrapper>>;
    public startProjectBuild(projectId: number, stage?: string, branch?: string, environment?: string, inputs?: RequestBuildInputs, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
