...
export class TokenService {
     ...
     */
    public createToken(token?: RequestToken, observe?: 'body', reportProgress?: boolean): Observable<ResponseToken>;
    public createToken(token?: RequestToken, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseToken>>;
    public createToken(token?: RequestToken, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseToken>>;
    public createToken(token?: RequestToken, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getToken(tokenId: number, observe?: 'body', reportProgress?: boolean): Observable<ResponseToken>;
    public getToken(tokenId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseToken>>;
    public getToken(tokenId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseToken>>;
    public getToken(tokenId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTokenList(limit?: number, offset?: number, orderby?: Array<string>, userName?: string, userNameMatch?: string, observe?: 'body', reportProgress?: boolean): Observable<ResponsePaginatedTokens>;
    public getTokenList(limit?: number, offset?: number, orderby?: Array<string>, userName?: string, userNameMatch?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponsePaginatedTokens>>;
    public getTokenList(limit?: number, offset?: number, orderby?: Array<string>, userName?: string, userNameMatch?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponsePaginatedTokens>>;
    public getTokenList(limit?: number, offset?: number, orderby?: Array<string>, userName?: string, userNameMatch?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * Deprecated since v5.0.0. Planned for removal in v6.0.0. Use &#x60;GET /token&#x60; instead.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * Returns arrays of tokens that match to search criteria. It takes into consideration only token string and user name. Deprecated since v5.0.0. Planned for removal in v6.0.0. Use &#x60;GET /token&#x60; instead.
     ...
     * Creates a new token if a match is not found. Deprecated since v5.0.0. Planned for removal in v6.0.0. Use POST /token to create, or PUT /token/{tokenId} to update instead.
     ...
     * Updates a token by replacing all of its fields.
     * @param tokenId ID of token to update
     * @param token New token values
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateToken(tokenId: number, token?: RequestTokenUpdate, observe?: 'body', reportProgress?: boolean): Observable<ResponseToken>;
    public updateToken(tokenId: number, token?: RequestTokenUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseToken>>;
    public updateToken(tokenId: number, token?: RequestTokenUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseToken>>;
    public updateToken(tokenId: number, token?: RequestTokenUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
