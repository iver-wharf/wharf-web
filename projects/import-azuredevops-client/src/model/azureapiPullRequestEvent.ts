 ...
 */
import { AzureapiPullRequestEventResource } from './azureapiPullRequestEventResource';


export interface AzureapiPullRequestEvent { 
    eventType?: string;
    resource?: AzureapiPullRequestEventResource;
}
